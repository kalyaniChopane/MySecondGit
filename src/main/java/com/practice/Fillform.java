...
public class Fillform {
	...
	public Fillform(WebDriver Driver1)//parameterized and local variable
	{
		driver=Driver1;//assign the value of local variable to global variable
	}
	public void form(){//method
